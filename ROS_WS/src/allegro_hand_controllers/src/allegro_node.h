...
const std::string JOINT_STATE_TOPIC_1 = "allegroHand/joint_states";
const std::string JOINT_STATE_TOPIC_2 = "/joint_states";
...
class AllegroNode {
 ...
 protected:
  ...
  // ROS stuff
  ros::NodeHandle nh;
  ros::Publisher joint_state_pub_1, joint_state_pub_2;
