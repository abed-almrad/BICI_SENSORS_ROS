...
/*
			...
			if((sensor_num ==23 || sensor_num ==28 || sensor_num ==11 || sensor_num ==16) && (i==message_length-4 || i==message_length-6)) // if we are reading the X or Y acceleration
			{
				msg.data.push_back(data_entry/265.0);
				continue;
